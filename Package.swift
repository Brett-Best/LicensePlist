...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/Brett-Best/LicensePlist/releases/download/3.27.7/LicensePlistBinary-macos.artifactbundle.zip",
            checksum: "daca7c46683786c3992e1087176f593e7f0f3fcb4b54762b108f6a6161c85bb7"
        ),
    ]
)
