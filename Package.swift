...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/Brett-Best/LicensePlist/releases/download/3.27.8/LicensePlistBinary-macos.artifactbundle.zip",
            checksum: "13dd31a38d1e999ae9a5c560330cbde51164d134499d29dc549393fc3a04d70f"
        ),
    ]
)
