...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/Brett-Best/LicensePlist/releases/download/3.27.6/LicensePlistBinary-macos.artifactbundle.zip",
            checksum: "8d2f2a732383358cec09afaa63e88942d662052dc7cb29164647afbe407eedab"
        ),
    ]
)
